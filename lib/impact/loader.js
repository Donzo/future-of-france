...
ig.Loader = ig.Class.extend({
	...
	draw: function() {
		...
		var w = (ig.system.width * 0.4).floor();
		var h = (ig.system.height * 0.2).floor();
		...
		*/
		...
		//LeftColor (blue)0047AB
		ig.system.context.fillStyle = '#0047AB';
		ig.system.context.fillRect( 0, 0, xBuffer, ig.system.height ); //X, Y, Width, Height
		//MiddleColor (white)
		ig.system.context.fillStyle = '#F8F8FF';
		ig.system.context.fillRect( xBuffer, 0, middleWdth, ig.system.height ); //X, Y, Width, Height
		//RightColor (red)
		ig.system.context.fillStyle = '#FF2136';
		ig.system.context.fillRect( xBuffer + middleWdth, 0, xBuffer, ig.system.height ); //X, Y, Width, Height
