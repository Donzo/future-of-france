...
EntityDooroutsidetwo = ig.Entity.extend({
	...
	doorNum: false,
	zIndex: -10000,
	animSheet: new ig.AnimationSheet( 'media/tile-work/city-door-03.png', 96, 75 ),
	...
	openThisDoor: function(){
		...
		ig.game.spawnEntity( EntityDoorwaytopcitytwo, this.pos.x, this.pos.y);
...
ig.EntityPool.enableFor( EntityDooroutsidetwo );
});
