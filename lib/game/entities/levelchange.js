	...
	check:function(other){
		if( other instanceof EntityPlayer ) {
			...
			if (!ig.game.changingLvl) {
				...
				if (ig.game.madeItToLvl < this.goesTo){
					ig.game.madeItToLvl = this.goesTo;
					console.log('ig.game.madeItToLvl = ' + ig.game.madeItToLvl);
				}
				saveGame(window['userAccountNumber'], ig.game.goingToLvl, ig.game.madeItToLvl) //Save Progress in DB
